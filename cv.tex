...
\begin{document}
    ...
    \cvsection{contact}{wetasphalt}{Line 1\\Line 2\\Line 3}
    ...
    \cvsection{skills}{alizarin}{%
        \begin{center}
            \begin{tikzpicture}
                ...
                \node [below=2, align=flush center] {language preference};
            \end{tikzpicture}
            \begin{tikzpicture}
                \pie[
                ...
                \node [below=2, align=flush center] {development environment preference};
            \end{tikzpicture}
        \end{center}
    }
